        ...
        <div className="mb-12 flex flex-col items-center gap-x-12 xl:flex-row">
          <div className="pt-6">
            <h1 className="pb-6 text-3xl font-extrabold leading-9 tracking-tight text-gray-900 dark:text-gray-100 sm:text-4xl sm:leading-10 md:text-6xl md:leading-14">
              Olá, eu sou{' '}
              <span className="text-primary-color-500 dark:text-primary-color-dark-500">Gnios</span>
            </h1>
            <h2 className="prose pt-5 text-lg text-gray-600 dark:text-gray-300">
              {`Bem-vindo ao ${siteMetadata.description}. Sou um Desenvolvedor Full Stack apaixonado por tecnologia e inovação. No meu tempo livre, gosto de desenvolver `}
              projetos pessoais e aprender novas tecnologias.
            </h2>
                  ...
                  <Link href="/projects">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        ...
                        <span className="pr-6 text-gray-900 dark:text-gray-100">O que construí</span>
                      </span>
                  ...
                  <Link href="/resume">
                    <span className="relative flex items-center divide-x divide-gray-600 rounded-lg bg-white px-7 py-4 leading-none dark:bg-black">
                      <span className="flex items-center space-x-5">
                        ...
                        <span className="pr-6 text-gray-900 dark:text-gray-100">Leia minha história</span>
                      </span>
