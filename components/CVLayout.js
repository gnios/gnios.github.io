  ...
  return (
    <>
      <PageSEO
        ...
        description={`Currículo profissional de ${name}, desenvolvedor full stack`}
      />
        ...
        <div className="cv-header">
          <div className="flex flex-col items-center space-y-4 md:flex-row md:items-start md:space-x-8 md:space-y-0">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="mb-2 text-xl font-semibold text-blue-200">{occupation}</h2>
              <p className="mb-4 text-gray-200">{company}</p>

              {/* Informações de Contato */}
              <div className="cv-contact-info flex flex-wrap justify-center gap-4 text-sm md:justify-start">
                <a
                  href={`mailto:${email}`}
        ...
        <div className="mx-auto max-w-4xl px-6 py-8">
          ...
          <div className="cv-section">
            ...
            <div className="prose max-w-none dark:prose-dark">
              <p className="leading-relaxed text-gray-700 dark:text-gray-300">{text1}</p>
              <p className="mt-4 leading-relaxed text-gray-700 dark:text-gray-300">{text2}</p>
              <p className="mt-4 leading-relaxed text-gray-700 dark:text-gray-300">{text3}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-6">
                  {experienceData.map((d, index) => (
                    <div key={index} className="cv-experience-item">
                      ...
                      <p className="mb-3 text-sm text-gray-600 dark:text-gray-400">{d.location}</p>
                        ...
                        <div className="cv-courses">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {education.courses.map((course, courseIndex) => (
                              <span key={courseIndex} className="cv-course-tag">
                                {course}
                              </span>
                            ))}
                          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="cv-section">
                <h3 className="cv-section-title">Informações Adicionais</h3>
