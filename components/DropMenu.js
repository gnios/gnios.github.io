      ...
      >
        <Menu.Items className="absolute right-0 mt-2 w-56 origin-top-right divide-y divide-zinc-300 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:divide-zinc-700 dark:bg-zinc-800 ">
          <div className="py-1">
            ...
            {/* Seção de autenticação removida para compatibilidade com GitHub Pages */}
          </div>
          <div className="py-1">
            <Menu.Item>
              {({ active }) => (
            ...
            {/* Guestbook removido - página não existe */}
            {/* Uses removido - página não existe */}
            {/* Now removido - página não existe */}
            {/* Stats removido - página não existe */}
            {/* Journey removido - página não existe */}
            {/* Recommends removido - página não existe */}
            {/* Quotes removido - página não existe */}
            {/* Activity removido - página não existe */}
            {/* Tweets removido - página não existe */}
          </div>
        </Menu.Items>
      </Transition>
    </Menu>
