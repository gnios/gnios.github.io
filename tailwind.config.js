      ...
      typography: () => ({
        DEFAULT: {
          css: {
            ...
            thead: { borderBottomColor: '#E6E6E6' },
            'thead th': { color: '#191919' },
            'tbody tr': { borderBottomColor: '#E6E6E6' },
          },
        },
        dark: {
          css: {
            ...
            table: { display: 'block', overflowX: 'auto', width: '100%' },
            thead: { borderBottomColor: '#292929' },
            'thead th': { color: '#FAFAFA' },
            'tbody tr': { borderBottomColor: '#292929' },
          },
        },
      }),
      keyframes: {
